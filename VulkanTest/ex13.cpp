...
class HelloTriangleApplication13
{
...
#pragma region GRAPHICS PIPELINE
	void createGraphicsPipeline()
	{
		...
		// creating graphics pipeline using our: shader stages, fixed function states, pipeline layouts and render passes.
		...
		// render pass and subpass index
		pipelineInfo.renderPass = renderPass;
		pipelineInfo.subpass = 0;

		// specify derivative pipeline info
...
int exercise13()
{
	HelloTriangleApplication13 app;
